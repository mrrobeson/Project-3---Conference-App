...
# addSesssionToWishlist(SessionKey) -- adds the session to users list of sessions they
# are interested in attending

# getSessionsInWishlist()--query for all the sessions in a conference that the user
# is interested in
